import pytest
from zconnect.testutils.util import model_to_dict, assert_successful_edit
from zconnect.testutils.fixtures import *
from zconnect.testutils import factories
from zconnect.testutils.factories import (DeviceEventDefinitionFactory,
                                          OrganizationFactory)
from zconnect.testutils.helpers import expect_model, expect_detail, expect_list
...
class TestEventDefinitionsEndpoint:
    ...
    def test_get_by_reference(self, testclient, fredbloggs):
        ...
        event_def_1 = factories.DeviceEventDefinitionFactory(device=device,
                                                             product=None,
                                                             ref="abcde")
        event_def_2 = factories.DeviceEventDefinitionFactory(device=device,
                                                             product=None,
                                                             ref="bcdef")
