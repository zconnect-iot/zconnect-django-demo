...
from zconnect.testutils.factories import DeviceEventDefWithActivityFactory


@pytest.fixture(name="fake_device_event_def_activity")
def fix_fake_device_event_def_with_activity(db, fake_site, joeseed, fakedevice):
    """
